...
public class RedCloseAuton extends LinearOpMode{
    ...
    public void runOpMode() {
        ...
        TrajectorySequence CenterCycle = robot.drive.trajectorySequenceBuilder(startLocation)
                ...
                .splineToConstantHeading(new Vector2d(14.00, -30.55), Math.toRadians(90))   // Drop pixel
                .waitSeconds(0.1)
                ...
                .splineToConstantHeading(new Vector2d(-56.00, -8.50), Math.toRadians(0.00)) // Reverse from  starter stack
                .UNSTABLE_addTemporalMarkerOffset(0.75, () -> {
                    robot.intake.engageLock(true,true);
        ...
        TrajectorySequence LeftCycle = robot.drive.trajectorySequenceBuilder(startLocation)
                ...
                .splineToConstantHeading(new Vector2d(-54.0, -14.25), Math.toRadians(0.00)) // Go into starter stack
                .waitSeconds(0.75)
                ...
                .splineToConstantHeading(new Vector2d(-54.00, -9.50), Math.toRadians(0.00)) // Reverse from  starter stack
                //add code to lock
